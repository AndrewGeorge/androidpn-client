...
public class NotificationSettingsActivity extends PreferenceActivity {
	...
	private PreferenceScreen createPreferenceHierarchy() {
		...
		CheckBoxPreference autoStar = new CheckBoxPreference(this);
		autoStar.setKey(Constants.SETINGS_AUTO_START);
		autoStar.setTitle("AutoStart");
		autoStar.setSummary("Auto Start server at boot");
		autoStar.setDefaultValue(Boolean.TRUE);
